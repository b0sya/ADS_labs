...
expected crash won't kill the test program (i.e. the p process). As a
result, any in-memory side effects they incur are observable in their respective
sub-processes, but not in the p process. You can think of them as running
in a parallel universe, more or less.

In particular, if you use [gMock](../../googlemock) and the death test statement
invokes some mock methods, the p process will think the calls have never
...
In particular, death tests don't like having multiple threads in the p
...
makes it harder to search for real problems in the p's log. Therefore,
